      ...
      <div class="flex flex-col justify-between gap-8 mb-4 md:flex-row md:items-center">
        <div>
          <h5
            ...
            Situa&ccedil;&atilde;o Financeira
          </h5>
          <p class="block mt-1 font-sans text-base antialiased font-normal leading-relaxed text-gray-700">
            Aqui pode se exibir a situcao dos estudantes
          </p>
        </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="p-4">
              <div class="w-max">
                <div
                  class="relative grid bg-[#fd8a8a] text-[#ff0000]  items-center px-2 py-1 font-sans text-xs font-bold text-red-900 uppercase rounded-md select-none whitespace-nowrap bg-red-500/20">
